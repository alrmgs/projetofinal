<section style="min-height: calc(100vh - 83px)" class="light-bg">
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_feelings" role="tab" data-toggle="tab">Sentimentos</a></li>
        ...
        <div class="tab-content">
            ...
            <div id="tab_feelings" class="tab-pane">
                <div class="container-fluid">
                    <h2 class="text-center"><strong>Gerenciar Sentimentos</strong></h2>
                    <a id="btn_add_feeling" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Sentimento</i></a>
                    <table id="dt_feelings" class="table table-striped table-bordered">
                        <thead>
                            <tr class="tableheader">
                                <th class="dt-center">Nome</th>
...
<div id="modal_feeling" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">x</button>
                <h4 class="modal-title">Sentimentos</h4>
            </div>

            <div class="modal-body">
                <form id="form_feeling">

                    <input id="feeling_id" name="feeling_id" hidden>

                    <div class="form-group">
                        <label class="col-lg-2 control-label">Nome</label>
                        <div class="col-lg-10">
                            <input id="feeling_name" name="feeling_name" class="form-control" maxlength="100">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Imagem</label>
                        <div class="col-lg-10">
                            <img id="feeling_img_path" src="" style="max-height: 400px; max-height: 400px">
                            <label class="btn btn-block btn-info">
                                <i class="fa fa-upload"></i>&nbsp;&nbsp;Importar imagem
                                <input type="file" id="btn_upload_feeling_img" accept="image/*" style="display: none;">
                            </label>
                            <input id="feeling_img" name="feeling_img" hidden>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">Descrição</label>
                        <div class="col-lg-10">
                            <textarea id="feeling_description" name="feeling_description" class="form-control"></textarea>
                            <span class="help-block"></span>
                        </div>
                    </div>

                    <div class="form-group text-center">
                        <button type="submit" id="btn_save_feeling" class="btn btn-primary">
                            <i class="fa fa-save"></i>&nbsp;&nbsp;Salvar
                        </button>
                        <span class="help-block"></span>
                    </div>
